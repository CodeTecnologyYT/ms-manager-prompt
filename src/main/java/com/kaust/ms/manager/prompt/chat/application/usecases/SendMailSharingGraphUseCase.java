...
import com.kaust.ms.manager.prompt.chat.application.ISendMailSharingGraphUseCase;
...
public class SendMailSharingGraphUseCase implements ISendMailSharingGraphUseCase {
     ...
     */
    private final static String NAME_ATTACHMENT_FILE = "sharing-graph-attachment.pdf";
    /**
     * TITLE_SHARING_EMAIL.
     */
    private final static String TEXT_TITLE_SHARING_EMAIL = "A document of graph was shared with you";
    /**
